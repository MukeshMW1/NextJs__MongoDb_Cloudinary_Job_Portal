...
const Job = ({job}) => {
  ...
  return (
    <>
    <div className='border-2 border-gray-300 rounded-lg  flex justify-between items-center my-10 p-4 md:p-8 shadow-md shadow-amber-300 hover:shadow-lg hover:scale-105 transition-all duration-300 ease-in-out  '>
      <div className="">
<h2 className='font-bold text-[16px] md:text-[20px]'>{job?.title}</h2>
